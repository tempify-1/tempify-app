...
export interface MfFieldArrayProps {
  field: Field;
  formStore: FormStore<Record<string, any>, undefined>;
}

export interface MfFieldArrayItemProps {
  field: Field;
  formStore: FormStore<Record<string, any>, undefined>;
  index: number;
  id: string;
...
export const MfFieldArray = component$<MfFieldArrayProps>(
...
export const MfFieldArrayItem = component$<MfFieldArrayItemProps>(
