...
import type { MfFieldArrayItemProps } from "../mf-field-array/mf-field-array";
import type { FieldValueObject } from "../mf-form/form-types";
import {
  IconCloseOutline,
...
import { MfArrayComboboxModal } from "./mf-array-combobox-modal";
import { AppButton } from "~/components/ui/app-button/app-button";
import { BADGE_CLASS, getItemLabel } from "./mf-array-combobox-utils";

export const MfArrayComboboxItem = component$<MfFieldArrayItemProps>(
